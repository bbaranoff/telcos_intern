...
## Partie 2 — Implémentation du réseau SS7 et analyse des dumps
...
### 2.1 Le rôle du réseau SS7 dans l’architecture GSM
...
### 2.2 SS7 sur IP : SIGTRAN et M3UA
...
### 2.3 L’architecture multi-opérateurs
...
### 2.5 Observer la signalisation avec les dumps
...
### 2.7 Un laboratoire pour l’étude de la signalisation mobile
...
# Partie 3 — Topologie réseau et implémentation SS7
