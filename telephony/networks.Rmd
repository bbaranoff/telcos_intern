...
### Architecture GSM/EGPRS

```{r gsm_architecture}
dot_code <- 'digraph gsm_arch {
  graph [rankdir=LR, bgcolor=transparent]
  node [shape=box, style=filled, fontname=Helvetica, fontsize=10, fillcolor="#B0E0E6"]
  ...
  SGSN [label="SGSN\n(osmo-sgsn)"]
  GGSN [label="GGSN\n(osmo-ggsn)"]
  STP [label="STP/SIGTRAN\n(osmo-stp)", fillcolor="#FFD700"]
...
```{r osmocombb_architecture}
dot_code <- 'digraph osmocombb {
  graph [rankdir=TB, bgcolor=transparent]
  node [shape=box, style=filled, fontname=Helvetica, fontsize=10, fillcolor="#FFFFE0"]
  edge [color=black, fontname=Helvetica, fontsize=9]
  
  host [label="PC Host\n(Layer23)"]
  fw [label="Firmware\n(Calypso/ARM)"]
  device [label="Motorola C1xx\n(C123/C118)"]
  
  host -> fw [label="osmocon"]
  fw -> device [label="USB-serial"]
  device -> host [label="L1CTL\nGSMTAP"]
}'
render_graphviz(dot_code)
```
...
```{r osmocom_stack}
dot_code <- 'digraph osmocom_stack {
  graph [rankdir=TB, bgcolor=transparent]
  node [shape=box, style=filled, fontname=Helvetica, fontsize=10, fillcolor="#90EE90"]
  edge [color=black, fontname=Helvetica, fontsize=9]
...
```{r ss7_routing}
dot_code <- 'digraph ss7_arch {
  graph [rankdir=TB, bgcolor=transparent]
  node [shape=box, style=filled, fontname=Helvetica, fontsize=10, fillcolor="#FFB6C1"]
  edge [color=black, fontname=Helvetica, fontsize=9]
  
  MSC1 [label="MSC 1\nPC: 1.1.1"]
  MSC2 [label="MSC 2\nPC: 1.2.1"]
  MSC3 [label="MSC 3\nPC: 1.3.1"]
  STP [label="STP\n(Router SS7)\nPC: 1.0.1", fillcolor="#FFD700"]
...
### Architecture 5G SA (Open5GS + srsRAN)

```{r 5g_architecture}
dot_code <- 'digraph 5g_arch {
  graph [rankdir=LR, bgcolor=transparent]
  node [shape=box, style=filled, fontname=Helvetica, fontsize=10, fillcolor="#E0FFFF"]
  edge [color=black, fontname=Helvetica, fontsize=9]
