...
\pandocbounded{\includegraphics[keepaspectratio]{pictures/couverture.png}}
...
\subsubsection{1. Télécharger Ubuntu}\label{tuxe9luxe9charger-ubuntu}
...
\subsubsection{2. Créer une clé USB
...
\subsubsection{3. Démarrer sur la clé
...
\subsubsection{4. Installer Ubuntu}\label{installer-ubuntu}
...
\subsubsection{5. Mise à jour du
...
\section{La clé RTL-SDR}\label{la-cluxe9-rtl-sdr}
...
\section{ADALM-PLUTO}\label{adalm-pluto}
...
\section{LimeSDR Mini}\label{limesdr-mini}
...
\section{HackRF One}\label{hackrf-one}
...
\section{LibreSDR}\label{libresdr}
...
\section{USRP B210}\label{usrp-b210}
...
\section{USRP X310}\label{usrp-x310}
...
\subsection{La clé RTL-SDR}\label{la-cluxe9-rtl-sdr-1}

\pandocbounded{\includegraphics[keepaspectratio]{pictures/rtl.jpg}}
...
\section{OsmocomBB}\label{osmocombb}
...
\subsection{Qu'est-ce qu'OsmocomBB\,?}\label{quest-ce-quosmocombb}
...
\subsection{Matériel supporté}\label{matuxe9riel-supportuxe9}
...
\subsection{Cas d'usage \& limitations}\label{cas-dusage-limitations}
...
\subsection{3. Installer la toolchain ARM (cross-compile
...
\subsection{4. Cloner et compiler
...
\subsection{5. Flasher le firmware Mobile (Compal/C123
...
\subsection{\texorpdfstring{6. Configurer \texttt{mobile.cfg} (SIM,
PLMN, log,
etc.)}{6. Configurer mobile.cfg (SIM, PLMN, log, etc.)}}\label{configurer-mobile.cfg-sim-plmn-log-etc.}
...
\subsection{8. (Optionnel) Suivi GSMTAP dans
...
\subsection{Liens utiles}\label{liens-utiles-1}
...
\subsection{1. Dépendances système}\label{duxe9pendances-systuxe8me-1}
...
\subsection{2. Installer la toolchain ARM-elf (cross-compiler
...
\subsection{3. Compiler et installer
OsmocomBB}\label{compiler-et-installer-osmocombb}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 1. Cloner les sources}
\FunctionTok{git}\NormalTok{ clone https://github.com/osmocom/osmocom{-}bb.git}
\BuiltInTok{cd}\NormalTok{ osmocom{-}bb}

\CommentTok{\# 2. Préparer le build}
\BuiltInTok{cd}\NormalTok{ src}
\ExtensionTok{autoreconf} \AttributeTok{{-}i}

\CommentTok{\# 3. Compiler le firmware (spécifie la toolchain si besoin)}
\BuiltInTok{export} \VariableTok{PATH}\OperatorTok{=}\VariableTok{$PATH}\NormalTok{:/opt/arm{-}2021.03/bin}
\ExtensionTok{./configure}
\FunctionTok{make} \AttributeTok{{-}j}\VariableTok{$(}\FunctionTok{nproc}\VariableTok{)}
\FunctionTok{sudo}\NormalTok{ make install}
...
\subsection{4. Flasher le firmware sur les
...
\subsection{5. Lancer le transceiver et la stack
...
\subsection{6. (Optionnel) Installer Asterisk + LCR pour appels
...
\subsection{7. Vérifier le setup et
...
\subsection{1. Prérequis}\label{pruxe9requis-1}
...
\subsubsection{1. Prérequis}\label{pruxe9requis-2}
...
\section{Configuration matérielle}\label{configuration-matuxe9rielle-1}
