...
Le système de **Claude Chappe**, développé en France à la fin du XVIII siècle, est l’un des premiers véritables réseaux de communication à distance.  
...
Au début du XIX siècle, les progrès en **électricité et en électromagnétisme** transforment progressivement la manière dont les scientifiques comprennent les phénomènes physiques.
...
## L’unification de l’électricité et du magnétisme : Maxwell
...
Au milieu du XIX siècle, les expériences de **Faraday** avaient déjà montré qu’un champ magnétique variable pouvait produire un courant électrique.  
...
cellule A \textbar{} cellule B \textbar{} cellule C
...
\subsection{La clé RTL-SDR}\label{la-cluxe9-rtl-sdr}

\pandocbounded{\includegraphics[keepaspectratio]{pictures/rtl-sdr.jpg}}
...
\section{Installation des outils RTL-SDR sous
...
\pandocbounded{\includegraphics[keepaspectratio]{pictures/gqrx.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{pictures/grgsm_scan.png}}
...
\subsection{Partie 2 --- Implémentation du réseau SS7 et analyse des
dumps}\label{partie-2-impluxe9mentation-du-ruxe9seau-ss7-et-analyse-des-dumps}
...
\subsubsection{2.1 Le rôle du réseau SS7 dans l'architecture
...
\subsubsection{2.2 SS7 sur IP : SIGTRAN et
...
\subsubsection{2.3 L'architecture
...
\subsubsection{2.4 Le rôle des point
...
\subsubsection{2.5 Observer la signalisation avec les
...
\subsubsection{2.6 Analyse des traces
...
\subsubsection{2.7 Un laboratoire pour l'étude de la signalisation
...
\section{Partie 3 --- Topologie réseau et implémentation
SS7}\label{partie-3-topologie-ruxe9seau-et-impluxe9mentation-ss7}
...
\section{3. Topologie réseau Docker}\label{topologie-ruxe9seau-docker}
...
\section{4. Signalisation SS7}\label{signalisation-ss7}
...
\pandocbounded{\includegraphics[keepaspectratio]{diagrams/ss7_topology.png}}
...
\section{Fin de la partie SS7 --- Observabilité et
...
\subsection{1. Installation rapide via PPA
...
\subsection{2. Compilation depuis les
...
\subsection{3. Générer/Configurer une SIM (IMSI, Ki,
...
\subsection{4. Programmer une carte SIM réelle
...
\subsection{5. Lancer srsENB (eNodeB) et srsEPC
...
\subsection{6. Tester l'attachement UE}\label{tester-lattachement-ue}
...
\subsection{1. Objectifs et rupture de la
...
\subsection{2. Ruptures techniques
...
\subsection{3. Nouveaux usages rendus
...
\subsection{4. Limites, critiques et
...
\subsection{5. Tableau récapitulatif}\label{tableau-ruxe9capitulatif}
...
\subsection{6. À retenir}\label{uxe0-retenir}
...
\subsection{1. Prérequis}\label{pruxe9requis}
...
\subsection{2. Installer Open5GS (Core
...
\subsection{3. Installer srsRAN Project
...
\subsection{4. Configurer Open5GS (Core)}\label{configurer-open5gs-core}
...
\subsection{5. Configurer srsRAN gNB}\label{configurer-srsran-gnb}
...
\subsection{6. Configurer srsRAN UE (si test en pur
...
\subsection{7. Lancer le Core Open5GS}\label{lancer-le-core-open5gs}
...
\subsection{8. Lancer le gNB srsRAN}\label{lancer-le-gnb-srsran}
...
\subsection{9. (Optionnel) Lancer le srsUE (UE 5G SA
...
\subsection{10. Supervision}\label{supervision}
...
\section{1 --- Architecture d'un réseau
...
\href{assets/uml.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/uml.png}}}
...
\subsection{Exemple de gateway LoRa}\label{exemple-de-gateway-lora}

Dans ce projet, une gateway \textbf{Dragino LoRa} a été utilisée.

\href{assets/WiFi_Dragino.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/WiFi_Dragino.png}}}
...
\section{2 --- Configuration de la gateway
...
\href{assets/config_gw_ttn.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/config_gw_ttn.png}}}
...
\href{assets/config_ttn_gw.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/config_ttn_gw.png}}}
...
\subsection{Installation du système sur Raspberry
...
\href{assets/choose_os.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/choose_os.png}}}
...
\href{assets/options_sd_rpi.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/options_sd_rpi.png}}}
...
\section{3 --- Enregistrement des capteurs
...
\href{assets/add_enddevice.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/add_enddevice.png}}}
...
\href{assets/register_enddevice.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/register_enddevice.png}}}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{Encodage des données}\label{encodage-des-donnuxe9es}
...
\href{assets/format_cayenne.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/format_cayenne.png}}}
...
\href{assets/coordonnees_ttn.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/coordonnees_ttn.png}}}
...
\href{assets/add_new_cayenne.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/add_new_cayenne.png}}}

Une fois le capteur connecté, les données peuvent être affichées sous
forme de tableaux ou de graphiques.

\href{assets/dragino_cayenne.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/dragino_cayenne.png}}}
...
\href{assets/gps_live.png}{\pandocbounded{\includegraphics[keepaspectratio]{assets/gps_live.png}}}
...
\subsection{1. Préparer le système}\label{pruxe9parer-le-systuxe8me}
...
\subsection{2. Installer Kraken}\label{installer-kraken}
...
\subsection{3. Installer ou télécharger les Rainbow
...
\subsection{4. Installer behemoth.py}\label{installer-behemoth.py}
...
\subsection{5. Utiliser Kraken (manuel et avec
...
\subsection{6. Schéma résumé}\label{schuxe9ma-ruxe9sumuxe9}
...
\subsubsection{1. Prérequis}\label{pruxe9requis-1}
...
\subsubsection{2. Cloner le code}\label{cloner-le-code}
...
\subsubsection{3. Télécharger les tables
...
\subsubsection{4. Installer les tables}\label{installer-les-tables}
...
\subsubsection{5. Configurer Deka}\label{configurer-deka}
...
\subsubsection{6. Générer le kernel
...
\subsubsection{8. Lancer Deka / Kraken}\label{lancer-deka-kraken}
...
\subsubsection{9. Connexion \& test de
...
\subsubsection{10. Monitoring \& tuning
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# 1. Dépendances}
\FunctionTok{sudo}\NormalTok{ apt install git build{-}essential python3{-}pip ocl{-}icd{-}libopencl1 opencl{-}headers clinfo}
\ExtensionTok{pip3}\NormalTok{ install pyopencl}

\CommentTok{\# 2. Cloner le code}
\FunctionTok{git}\NormalTok{ clone https://github.com/0x7678/typhon{-}vx.git}
\BuiltInTok{cd}\NormalTok{ typhon{-}vx/kraken}

\CommentTok{\# 3. Télécharger les tables (\textasciitilde{}1,7To)}

\CommentTok{\# 4. Installer les tables (TableConvert ou install.py)}

\CommentTok{\# 5. Éditer delta\_config.h (chemins absolus/UUID)}

\CommentTok{\# 6. Générer kernel : ./genkernel32.sh \textgreater{} slice.c}

\CommentTok{\# 7. Lancer : paplon.py, oclvankus.py, delta\_client.py}

\CommentTok{\# 8. Connexion : telnet localhost 1578, commande "crack"}

\CommentTok{\# 9. Tune (stats, kernel, stockage)}
\end{Highlighting}
\end{Shaded}
...
\section{Principe général de la redirection
...
\subsection{Pile LTE (point d'ancrage)}\label{pile-lte-point-dancrage}
...
\subsection{Pile 2G (réseau cible)}\label{pile-2g-ruxe9seau-cible}
...
\section{Rôle des identités réseau (MNO /
...
\section{Mécanisme de fallback}\label{muxe9canisme-de-fallback}
...
\subsection{Cas MVNO}\label{cas-mvno}
...
\subsection{Cas MNO}\label{cas-mno}
...
\section{Méthodologie de l'attaque}\label{muxe9thodologie-de-lattaque}
...
\section{Démonstration du COSIC sur un véhicule
...
\section{Enseignements pour la sécurité des systèmes
...
\section{Suite de rétro-ingénierie et de brute-force
...
\section{La théorie : pourquoi c'est
...
\section{Performance et stratégie (méthode
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{pictures/iacr.png}}
\caption{IACR Algorithm}
\end{figure}

\subsubsection{1. Constantes inconnues}\label{constantes-inconnues}
...
\subsubsection{2. Constantes connues}\label{constantes-connues}
...
\section{Configuration matérielle}\label{configuration-matuxe9rielle}
...
\subsection{2. Recherche rapide (constante 1 octet
...
\subsection{3. Recherche constructeur (constantes 2
...
\subsection{4. Reverse complet (mode
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{pictures/demo.png}}
\caption{Search Demo}
\end{figure}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Tutoriel : générateur de signature
...
\section{Construction de la clé}\label{construction-de-la-cluxe9}
...
\section{Utilisation basique}\label{utilisation-basique}
...
\section{Détail de la sortie}\label{duxe9tail-de-la-sortie}
...
\subsection{Le réseau TETRA}\label{le-ruxe9seau-tetra}
...
\section{Architecture du réseau}\label{architecture-du-ruxe9seau}
...
\section{Caractéristiques radio}\label{caractuxe9ristiques-radio}
...
\section{Sécurité}\label{suxe9curituxe9}
...
\section{Utilisations}\label{utilisations}
...
\subsection{Chiffrement TETRA et vulnérabilités révélées par Midnight
Blue
...
\section{La révélation de 2023}\label{la-ruxe9vuxe9lation-de-2023}
...
\section{Faiblesse principale de
...
\section{Impact potentiel}\label{impact-potentiel}
...
\section{Importance pour la recherche en sécurité
...
\section{TEA1 Key Brute-forcer (OpenCL
...
\subsubsection{1. Inversion du Keystream}\label{inversion-du-keystream}
...
\subsubsection{2. Algorithme de
recherche}\label{algorithme-de-recherche}
